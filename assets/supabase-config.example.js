...
window.ORRERY_CONFIG = {
  ...
  PLANS: {
    ...
    pro: {
      ...
      price: '$40',
      cadence: 'per month',
      summary: 'Orrery Relay-managed DeepSeek, Doubleword, and Arbiter pools, Nexus, and managed cloud features.',
      features: ['Google, GitHub, and email cloud sign-in', 'DeepSeek pool - 8M credits/month', 'Doubleword pool - 8M credits/month', 'Arbiter pool - 4M credits/month', 'Nexus operations'],
    },
  },
  DEFAULT_PLAN: 'free',
